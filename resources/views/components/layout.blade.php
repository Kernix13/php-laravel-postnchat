...
<html lang="en">
  ...
  <body>
    ...
    @auth
    <div data-username="{{auth()->user()->username}}" data-avatar="{{auth()->user()->avatar}}" id="chat-wrapper" class="chat-wrapper shadow border-info border-top border-left border-right"></div>
    @endauth
